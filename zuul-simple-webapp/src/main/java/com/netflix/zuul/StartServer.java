...
public class StartServer implements ServletContextListener {
    ...
    private void initGroovyFilterManager() {
        ...
        scriptRoot = "E:/installation/apachetomcat/webapps/agroovy/filters";
        ...
        try {
        	...
        	System.out.println("scriptRoot ----   "+scriptRoot + "pre");
            System.out.println("scriptRoot ----   "+scriptRoot + "route");
            System.out.println("scriptRoot ----   "+scriptRoot + "post");

        	FilterFileManager.setFilenameFilter(new GroovyFileFilter());
                        
            FilterFileManager.init(5, scriptRoot + "pre", scriptRoot + "route", scriptRoot + "post");
            
            System.out.println("End scriptRoot ----  ");
